...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        bar_data= recession_data.groupby(['Vehicle_Type', 'unemployment_rate'])['Automobile_Sales'].sum().reset_index()
        R_chart4 = dcc.Graph(
            figure=px.bar(
            bar_data,
            x='unemployment_rate',
            y='Automobile_Sales',
            color='Vehicle_Type',  # Use color to represent different vehicle types
            )
)
...
# Plot 2 Total Monthly Automobile sales using line chart.
        total_monthy= yearly_data.groupby('Month')['Automobile_Sales'].sum().reset_index()

        Y_chart2 = dcc.Graph(figure=px.line(total_monthy, x='Month', y='Automobile_Sales', title='Total Monthly Automobile Sales '))
